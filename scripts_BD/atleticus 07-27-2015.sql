...
--
-- Servidor: localhost
-- Tiempo de generación: 27-07-2015 a las 20:11:47
...
(6, '2015-07-27', '09:00:00', '10:00:00', 4, 29),
(7, '2015-07-28', '09:00:00', '10:00:00', 5, 22),
(8, '2015-07-31', '09:00:00', '10:00:00', 5, 24),
(12, '2015-07-30', '09:00:00', '10:00:00', 4, 33),
(13, '2015-07-28', '20:30:00', '22:00:00', 8, 29),
(14, '2015-07-30', '20:30:00', '22:00:00', 8, 31),
(15, '2015-07-29', '20:30:00', '22:00:00', 9, 50),
(16, '2015-07-31', '20:30:00', '22:00:00', 9, 48),
(17, '2015-07-28', '10:00:00', '11:00:00', 6, 34),
(18, '2015-07-30', '10:00:00', '11:00:00', 6, 35),
(19, '2015-07-27', '10:00:00', '11:30:00', 7, 28),
(20, '2015-07-29', '10:00:00', '11:30:00', 7, 36),
(21, '2015-07-29', '20:30:00', '22:00:00', 10, 21),
(22, '2015-07-22', '09:00:00', '10:00:00', 4, 4),
(23, '2015-08-03', '09:00:00', '10:00:00', 4, 29),
(24, '2015-08-07', '09:00:00', '10:00:00', 4, 29),
(25, '2015-08-04', '09:00:00', '10:00:00', 5, 22),
(26, '2015-08-06', '09:00:00', '10:00:00', 5, 22),
(27, '2015-08-04', '20:30:00', '22:00:00', 8, 28),
(28, '2015-08-06', '20:30:00', '22:00:00', 8, 31),
(29, '2015-08-05', '20:30:00', '22:00:00', 9, 50),
(30, '2015-08-07', '20:30:00', '22:00:00', 9, 48),
(31, '2015-08-04', '10:00:00', '11:00:00', 6, 34),
(32, '2015-08-06', '10:00:00', '11:00:00', 6, 35),
(33, '2015-08-03', '10:00:00', '11:30:00', 7, 27),
(34, '2015-08-05', '10:00:00', '11:30:00', 7, 37),
(35, '2015-08-05', '20:30:00', '22:00:00', 10, 21);
...
CREATE TABLE IF NOT EXISTS `calificaciones` (
  ...
  `id_calificacion_tipo` int(11) NOT NULL,
  `comentario` varchar(160) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `calificaciones-tipo`
--

CREATE TABLE IF NOT EXISTS `calificaciones-tipo` (
  `id_calificacion_tipo` int(11) NOT NULL,
  `calificacion_tipo` varchar(15) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Volcado de datos para la tabla `calificaciones-tipo`
--

INSERT INTO `calificaciones-tipo` (`id_calificacion_tipo`, `calificacion_tipo`) VALUES
(1, 'Excelente'),
(2, 'Muy Bueno'),
(3, 'Bueno'),
(4, 'Regular'),
...
INSERT INTO `reservas` (`id_reserva`, `id_usuario`, `id_calendario_profesor_actividad`) VALUES
(1, 18, 6),
(2, 18, 22),
(8, 18, 20),
(9, 18, 16),
...
(78, 18, '2015-07-14', 3, '1111111111111111', 1737),
(79, 18, '2015-07-14', 3, '1111111111111111', 4385),
(80, 18, '2015-07-25', 2, '1111111111111111', 638);
...
ALTER TABLE `calificaciones`
  ADD PRIMARY KEY (`id_calificacion`), ADD KEY `id_reserva` (`id_reserva`), ADD KEY `id_calificacion_tipo` (`id_calificacion_tipo`);

--
-- Indices de la tabla `calificaciones-tipo`
--
ALTER TABLE `calificaciones-tipo`
  ADD PRIMARY KEY (`id_calificacion_tipo`);
...
--
ALTER TABLE `calendario-profesor-actividad`
  MODIFY `id_calendario_profesor_actividad` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36;
--
...
--
-- AUTO_INCREMENT de la tabla `calificaciones-tipo`
--
ALTER TABLE `calificaciones-tipo`
  MODIFY `id_calificacion_tipo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `calificaciones`
ADD CONSTRAINT `calificaciones_ibfk_1` FOREIGN KEY (`id_reserva`) REFERENCES `reservas` (`id_reserva`),
ADD CONSTRAINT `calificaciones_ibfk_2` FOREIGN KEY (`id_calificacion_tipo`) REFERENCES `calificaciones-tipo` (`id_calificacion_tipo`);
