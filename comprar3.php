        ...
        <div class="container-fluid cuerpo">
            ...
            <div class="container cuerpo-comprar">
                ...
                <div class="col-md-6 pagos">
                    ...
                    <div class="row datos-comprador">
                        <h3>Datos del comprador:</h3>
                        
                        <h4><b>Nombre:</b> <?php echo $datos["datos_usuario_nombre"]?></h4>
                        <h4><b>Apellido:</b> <?php echo $datos["datos_usuario_apellido"]?></h4>
                        <h4><b>Dni:</b> <?php echo $datos["datos_usuario_dni"]?></h4>
                    </div>
                    <div class="row forma-pago">
                        <h3>Forma de pago:</h3>
                        
                        <h4><b>Tarjeta:</b> <?php echo $datosTarjeta["tarjetas_tipo"]?></h4>
                        <h4><b>Numero:</b> <?php echo "xxxx-".substr($_SESSION["tarjeta"]["numero-tarjeta"], 12); ?></h4>
                    </div>
                    
                    <form id="btn-comprar" method="post" action="actions/api-realizar-compra.php">
                        <a href="comprar2.php">
                            <button type="button" class="btn btn-default">Volver</button>
                        </a>
                        <input type="hidden" name="total" value="<?php echo $total; ?>">
                        <button name="action" value="comprar" type="submit" class="btn btn-success" >Confirmar compra</button>
                    </form>
